...
<body>
    ...
    <div>
        ...
        <asp:ListView ID="ListView1" runat="server" DataKeyNames="TypeId" DataSourceID="ObjectDataSource1" InsertItemPosition="LastItem">
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="Shop.Model.BookType" DeleteMethod="Delete" InsertMethod="Add" SelectMethod="GetAllList" TypeName="Shop.BLL.BookType" UpdateMethod="Update"></asp:ObjectDataSource>
